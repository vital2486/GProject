...
UENUM(BlueprintType)
enum class EGiantStatus : uint8
{
	EGS_Idle			UMETA(DisplayName = "Idle"),
	EGS_Aggro			UMETA(DisplayName = "Aggro"),
...
UCLASS()
class GPROJECT_API AGiant : public ACharacter
{
	GENERATED_BODY()
...
public:	
	...
	FORCEINLINE void SetGiantStatus(EGiantStatus Status) { GiantStatus = Status; }
	FORCEINLINE EGiantStatus GetGiantStatus() { return GiantStatus; }
